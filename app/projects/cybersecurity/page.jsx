        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 max-w-6xl w-full mx-auto">
          <Card>
            <CardHeader className="flex flex-row items-center gap-4">
              ...
              <div className="grid gap-1">
                <CardTitle>Cybersecurity-1 </CardTitle>
                <CardDescription>cybersecurity1.xyz.com</CardDescription>
              </div>
              <DropdownMenu>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center gap-4">
              ...
              <div className="grid gap-1">
                <CardTitle>Cybersecurity-2</CardTitle>
                <CardDescription>cybersecurity2.xyz.com</CardDescription>
              </div>
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button className="ml-auto" size="icon" variant="ghost">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center gap-4">
              ...
              <div className="grid gap-1">
                <CardTitle>Cybersecurity-3</CardTitle>
                <CardDescription>cybersecurity3.xyz.com</CardDescription>
              </div>
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button className="ml-auto" size="icon" variant="ghost">
