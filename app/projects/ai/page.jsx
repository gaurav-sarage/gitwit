        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 max-w-6xl w-full mx-auto">
          <Card>
            <CardHeader className="flex flex-row items-center gap-4">
              ...
              <div className="grid gap-1">
                <CardTitle>AI-1 </CardTitle>
                <CardDescription>ai1.xyz.com</CardDescription>
              </div>
              <DropdownMenu>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center gap-4">
              ...
              <div className="grid gap-1">
                <CardTitle>AI-2</CardTitle>
                <CardDescription>ai2.xyz.com</CardDescription>
              </div>
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button className="ml-auto" size="icon" variant="ghost">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center gap-4">
              ...
              <div className="grid gap-1">
                <CardTitle>AI-3</CardTitle>
                <CardDescription>ai3.xyz.com</CardDescription>
              </div>
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button className="ml-auto" size="icon" variant="ghost">
